Есть возможность голосовать через кошельки, сгенерированные yarn chain (можно и через дефолтный, но тогда нужно нажать кнопку "Grab funds"). Для этого надо совершить следующую последовательность действий:
